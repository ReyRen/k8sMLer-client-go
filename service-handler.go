...
func Create_service(svcClient v1.ServiceInterface, serviceName string, labelName string, gracePeriodSeconds *int64) {
	var service apiv1.Service

	ServiceReady(&service, serviceName, labelName, gracePeriodSeconds)
